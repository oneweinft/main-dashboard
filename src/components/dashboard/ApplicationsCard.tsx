  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-primary text-base font-bold">Applications</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-foreground">137</span>
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <div className="flex items-center justify-center gap-1 mt-0.5">
              ...
              <span className="text-xs text-muted-foreground">Returned Refs</span>
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center justify-center gap-1 mt-0.5">
              ...
              <span className="text-xs text-muted-foreground">Pending LL</span>
            </div>
          </div>
          <div>
            <span className="text-xl font-bold text-foreground">0</span>
            <div className="flex items-center justify-center gap-1 mt-0.5">
              ...
              <span className="text-xs text-muted-foreground">Pending TT</span>
            </div>
          </div>
        </div>

        <div className="border-t pt-3">
          <CardTitle className="text-primary text-base font-bold mb-2">New Lease</CardTitle>
          <div className="flex items-baseline gap-2">
          ...
          <div className="grid grid-cols-3 gap-4 text-center mt-3">
            <div>
              ...
              <div className="flex items-center justify-center gap-1 mt-0.5">
                <span className="h-2 w-2 rounded-full bg-info" />
                <span className="text-xs text-muted-foreground">Pending Bond</span>
              </div>
            </div>
            <div>
